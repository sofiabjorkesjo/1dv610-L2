...
private function generateRegisterForm(){
    ...
    <form action="?register" method="post" enctype="multipart/form-data">
        <fieldset>
            ...
            <br>
            <label for="RegisterViewPasswordRepeat">Repeat password :</label>
            <input type="password" size="20" namw="RegisterView::PasswordRepeat" id="RegisterView::PasswordRepeat" value>
            <br>
